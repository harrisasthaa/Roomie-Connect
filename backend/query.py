...
def get_discover(email):
    ...
    matches = []
    keys = ["id", "first_name", "last_name", "gender", "age", "major", "university", "city_state", "price_upper", "price_lower", "about_me", "interest1", "interest2", "interest3", "full_time", "img_url"]
    for match_id in match_ids:
        c.execute(f"SELECT D.id, D.first_name, D.last_name, C.gender, D.age, C.major, D.university, C.city_state, C.price_upper, C.price_lower, D.about_me, C.interest1, C.interest2, C.interest3, D.img_url\
